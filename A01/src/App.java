...
public class App {
    public static void main(String[] args) {
        ...
        plt = new Plotter<>("uf/WUFvsQFvsQU_20_000_max.png", "Unions", "Time (ms)", Plotter.Type.SCATTER,"Weighted UnionFind vs QuickFind vs Quick Union @ fixed 20_000 nodes");
        race.runAll(20000, 200, 1000, plt);
        plt = new Plotter<>("uf/WUFvsQFvsQU_30_000_max.png", "Unions", "Time (ms)", Plotter.Type.SCATTER,"Weighted UnionFind vs QuickFind vs Quick Union @ fixed 30_000 nodes");
        race.runAll(30000, 300, 1000, plt);

        Plotter<Integer, Double> plt = new Plotter<>("uf/WUFvsQF_10_000_max.png", "Unions", "Time (ms)", Plotter.Type.LINEAR,"Weighted UnionFind vs Quick Find  @ fixed 10_000 nodes");
        ...
        */
        ...
        plt = new Plotter<>("uf/WUFvsQFvsQU_5_000_max.png", "Unions", "Time (ms)", Plotter.Type.SCATTER,"Weighted UnionFind vs QuickFind vs Quick Union @ fixed 5_000 nodes");
        race.runAll(500, 10, 100, plt);
        ...
        race.runAll(10000, 100, 1000, plt);
        plt = new Plotter<>("uf/WUFvsQFvsQU_20_000_max.png", "Unions", "Time (ms)", Plotter.Type.SCATTER,"Weighted UnionFind vs QuickFind vs Quick Union @ fixed 20_000 nodes");
        race.runAll(20000, 500, 5000, plt);

        plt = new Plotter<>("uf/WUFvsQF_10_000_max.png", "Unions", "Time (ms)", Plotter.Type.LINEAR,"Weighted UnionFind vs Quick Find  @ fixed 10_000 nodes");
        race.runWFvQF(10000, 250, 1000, plt);
        plt = new Plotter<>("uf/QFvsQU_10_000_max.png", "Unions", "Time (ms)", Plotter.Type.LINEAR,"Quick Union vs Quick Find  @ fixed 10_000 nodes");
        race.runQUvQF(10000, 250, 1000, plt);
