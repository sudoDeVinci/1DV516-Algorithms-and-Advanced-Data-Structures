...
public class Plotter {
    ...
    public <T,R> void plot(T[] x, R[] y) {
         ...
         */
        command = new String[]{KEYWORD, SCRIPT_PATH, graphPath, Arrays.toString(x).replaceAll("\\s+",""), Arrays.toString(y).replaceAll("\\s+",""), x_label, y_label, title, "'"+typeList.toString()+"'"};
